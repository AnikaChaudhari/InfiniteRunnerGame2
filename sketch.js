...
function preload(){
  trex_running =   loadImage("Trex.jpg");
  trex_collided = loadImage("TrexCollided.jpg");
  ...
  obstacle2 = loadImage("Cactus2.jpg");
  obstacle3 = loadImage("Cactus3.jpg");
  obstacle4 = loadImage("Cactus4.jpg");
